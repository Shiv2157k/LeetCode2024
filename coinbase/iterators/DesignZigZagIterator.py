...
if __name__ == "__main__":
    zig_zag_0 = ZigZagIteratorV0([1, 2, 3], [4, 5, 6])
    zig_zag_1 = ZigZagIteratorV1([1, 2, 3], [4, 5, 6])
    print(zig_zag_0.next(), zig_zag_1.next())
    print(zig_zag_0.hasNext(), zig_zag_1.hasNext())
    print(zig_zag_0.next(), zig_zag_1.next())
    print(zig_zag_0.next(), zig_zag_1.next())
    print(zig_zag_0.hasNext(), zig_zag_1.hasNext())
    ...
    zig_zag_01 = ZigZagIteratorV0([1, 2, 3], [4, 5, 6, 7])
    zig_zag_11 = ZigZagIteratorV1([1, 2, 3], [4, 5, 6, 8])
    print(zig_zag_01.next(), zig_zag_11.next())
    print(zig_zag_01.hasNext(), zig_zag_11.hasNext())
    print(zig_zag_01.next(), zig_zag_11.next())
    print(zig_zag_01.next(), zig_zag_11.next())
    print(zig_zag_01.hasNext(), zig_zag_11.hasNext())
    ...
    zig_zag_02 = ZigZagIteratorV0([1, 2, 3], [4, 5, 6, 7])
    zig_zag_12 = ZigZagIteratorV1([1, 2, 3], [4, 5, 6, 8])
    print(zig_zag_02.next(), zig_zag_12.next())
    print(zig_zag_02.hasNext(), zig_zag_12.hasNext())
    print(zig_zag_02.next(), zig_zag_12.next())
    print(zig_zag_02.next(), zig_zag_12.next())
    print(zig_zag_02.hasNext(), zig_zag_12.hasNext())